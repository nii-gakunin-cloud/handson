...
- 2026年9月2日(水) Web 型プログラミング教育支援システム活用ワークショップ（構築・運用と AI 活用編）
  ...
  - 山口大学のMCJ-CloudHub 構築事例及び大学初年次教育への活用事例
  - ミニ座談会用資料
...
- 2026年3月19日(木) Web 型プログラミング教育支援システム活用ワークショップ －MCJ-CloudHubとCoursewareHubによる実践事例と運用ノウハウ－
  ...
  [プログラム](./pdf/vcp-ws_program_20260318.pdf)
  - Web 型プログラミング教育支援システム、及びOCSの概要 [講演資料](./pdf/web型プログラミング教育支援システム概要-20260302-r1.pdf)
  - CoursewareHubの概要説明・最新動向 [講演資料](./pdf/hiroshima_CLE47_hamamoto.pdf)
...
- 2025年9月2日(火) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  ...
  - 講義・演習環境アプリケーション ハンズオン （演習）[Notebook2](./examples/MCJ-0902/01-manual.ipynb)
  - オンデマンド構築サービスの仕組みと環境構築概要 [教材](./pdf/オンデマンド構築サービスの仕組みと環境構築概要--20250808-r0.pdf)

- 2025年4月23日(水) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  - オンデマンド構築サービスと講義・演習環境MCJ-CloudHubの概要 [教材](./pdf/OCSとMCJ概要-20250423-r2.pdf)
  - 講義・演習環境アプリケーション ハンズオン （演習）[mamual 教材](./pdf/handson20250423_manual.pdf)
  - 講義・演習環境アプリケーション ハンズオン （演習）[Notebook1](./examples/MCJ-0423/assign01.ipynb)
  - 講義・演習環境アプリケーション ハンズオン （演習）[auto 教材](./pdf/handson20250423_auto.pdf)
  - 講義・演習環境アプリケーション ハンズオン （演習）[Notebook2](./examples/MCJ-0423/assign02.ipynb)
  - 講義・演習環境アプリケーション ハンズオン （演習）[shared 教材](./pdf/handson20250423_shared.pdf)
  - 講義・演習環境アプリケーション ハンズオン （演習）[Notebook3](./examples/MCJ-0423/assign03.ipynb)
...
- 2025年3月13日(木) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  ...
  - OCSテンプレート紹介と活用事例紹介 [教材](./pdf/OCSテンプレート紹介と活用事例紹介--20250313-r1.pdf) [実行スクリプト](https://github.com/nii-gakunin-cloud/handson/releases/download/handson-20250313/OOD_examples.zip)

- 2025年1月15日(水) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  - オンデマンド構築サービスと講義・演習環境MCJ-CloudHubの概要 [教材](./pdf/OCSとMCJ概要-r0.pdf)
  - 講義・演習環境MCJ-CloudHub構築ハンズオン [教材](./Application-Tutorials/handson202501-mcjcloudhub)

- 2024年9月11日(水) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  - オンデマンド構築サービスとOpen OnDemandの概要 [教材](./pdf/OCSとOODの概要-r2.pdf)
  - オンデマンド構築サービスを使用したOpenHPC + Open OnDemandの構築と活用 [教材](./Application-Tutorials/handson202409-openondemand)
  - OCSテンプレート紹介と活用事例紹介 [教材](./pdf/OCSテンプレート紹介と活用事例紹介-r1.pdf)

- 2024年8月28日(水) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  - オンデマンド構築サービスを使った講義・演習環境アプリケーション概要 [教材](./pdf/1.MCJ概要説明-20240828--r1.pdf)
  - 講義・演習環境アプリケーション ハンズオン（演習）[教材](./pdf/handson-20240828.pdf)
  - 講義・演習環境アプリケーション ハンズオン（演習）[Notebook1](./ipynb/20240828/01-basic.ipynb)
  - 講義・演習環境アプリケーション ハンズオン（演習）[Notebook2](./ipynb/20240828/02-basic.ipynb)
  - オンデマンド構築サービスの仕組みと環境構築概要 [教材](./pdf/3.OCSの仕組みと環境構築概要-20240828-r3.pdf)
  - テスト運用のご協力のお願い [教材](./pdf/3.テスト運用のご協力のお願い-20240828-r2.pdf)

## 2023年度ハンズオン
- 2024年2月29日(木) 学認クラウドオンデマンド構築サービスハンズオンセミナー
  - オンデマンド構築サービスの基礎、活用方法、及びアプリケーション構築演習（演習） [教材](./Basic-Tutorials/handson202402-vcp)
  - 公開テンプレート、お試し環境等のご説明 [資料](./pdf/公開テンプレート・お試し環境-2024.2.29-r3.pdf)
